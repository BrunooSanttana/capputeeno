...
export default function CartPage() {
    ...
    const handleFinalizarCompra = () => {
        const mensagem = 'Site ficticio, feito apenas para estudo. Agradecemos a interação até o final!';
        alert(mensagem);
      };
        ...
        <DefaultPageLayout>
            <Container>
                ...
                <CartResultContainer>
                    ...
                    <ShopBtn onClick={handleFinalizarCompra}> FINALIZAR COMPRA</ShopBtn>
                </CartResultContainer>
            </Container>
        </DefaultPageLayout>
    )
